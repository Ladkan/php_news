...
<?php 
    ...
    if(isset($_POST['author'], $_POST['category'], $_POST['title'], $_POST['pretext'], $_POST['text'], $_POST['id'])){
        $sql = 'UPDATE articles SET  author_id = :author_id, category_id = :category_id, title = :title, pretext = :pretext, text = :content where id = :id';
        $stmt = $conn ->prepare($sql);
        $stmt -> execute([
                    ...
                    <form action="" method="post" class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="author" id="author_input" class="form-select">
                                ...
                                <option 
                                <?php if($item['id'] == $article[0]['author_id']): ?>
                                selected
                                <?php endif ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="category" id="kategorie_input" class="form-select">
                                ...
                                <option 
                                <?php if($item['id'] == $article[0]['category_id']): ?>
                                selected
                                <?php endif ?>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="title_input" name="title" class="form-control" value="<?= $article[0]['title'] ?>">
                        </div>
                        <div class="col-12">
                            <label for="text_input" class="form-label">Pre Text</label>
                            <input type="text" id="text_input" name="pretext" class="form-control" value="<?= $article[0]['pretext'] ?>">
                        </div>

                        <textarea name="text" id="mytextarea">
                        <?= $article[0]['text'] ?>
                        </textarea>

                        <input class="disable" type="text" name="id" value="<?= $article[0]['id'] ?>">
